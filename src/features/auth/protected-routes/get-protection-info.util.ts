...
const pathnamesProtections: { [key: string]: UserRole[] } = {
  ...
  [APP_ROUTES.SEND_PROGRESS]: [USER_ROLES.BOSS],
  [APP_ROUTES.EXTEND_PROGRESS]: [USER_ROLES.BOSS, USER_ROLES.EMPLOYEE],
  ...
  [APP_ROUTES.API_SEND_PROGRESS]: [USER_ROLES.BOSS],
  ...
  [APP_ROUTES.API_EXTEND_PROGRESS]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
