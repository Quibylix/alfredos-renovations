...
const pathnamesProtections: { [key: string]: UserRole[] } = {
  ...
  [APP_ROUTES.EDIT_TASK]: [USER_ROLES.BOSS],
  ...
  [APP_ROUTES.API_LOGIN]: [USER_ROLES.ANON],
  [APP_ROUTES.API_LOGOUT]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.API_REGISTER_EMPLOYEE]: [USER_ROLES.BOSS],
  [APP_ROUTES.API_SET_TASK]: [USER_ROLES.BOSS],
  [APP_ROUTES.API_EDIT_TASK]: [USER_ROLES.BOSS],
  ...
  [APP_ROUTES.API_INCLUDE_FCM_TOKEN]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.API_UPDATE_TASK_STATUS]: [USER_ROLES.BOSS],
};
