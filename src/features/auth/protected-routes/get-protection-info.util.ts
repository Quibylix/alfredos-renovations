...
const pathnamesProtections: { [key: string]: UserRole[] } = {
  ...
  [APP_ROUTES.UPLOAD_IMAGE]: [USER_ROLES.EMPLOYEE],
  [APP_ROUTES.PROGRESS_LIST]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.PROGRESS]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.SEND_PROGRESS]: [USER_ROLES.EMPLOYEE],
  [APP_ROUTES.EXTEND_PROGRESS]: [USER_ROLES.EMPLOYEE],
  ...
  [APP_ROUTES.API_UPLOAD_IMAGE]: [USER_ROLES.EMPLOYEE],
  [APP_ROUTES.API_REGISTER_EMPLOYEE]: [USER_ROLES.BOSS],
  [APP_ROUTES.API_SEND_PROGRESS]: [USER_ROLES.EMPLOYEE],
  [APP_ROUTES.API_CHANGE_PASSWORD]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.API_GET_RELATED_PROGRESS]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.API_GET_RELATED_PROJECTS]: [USER_ROLES.EMPLOYEE, USER_ROLES.BOSS],
  [APP_ROUTES.API_EXTEND_PROGRESS]: [USER_ROLES.EMPLOYEE],
